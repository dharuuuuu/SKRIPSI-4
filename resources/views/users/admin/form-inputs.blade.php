...
<div class="flex flex-wrap">
    <x-inputs.group class="w-1/2">
        ...
        <x-inputs.text
            name="nama"
            :value="old('nama', ($editing ? $admin->nama : ''))"
            maxlength="255"
            placeholder="Nama"
            required
        ></x-inputs.text>
    ...
    <x-inputs.group class="w-1/2">
        ...
        <x-inputs.select name="jenis_kelamin">
            ...
            @php $selected = old('jenis_kelamin', ($editing ? $admin->jenis_kelamin : '')) @endphp
    ...
    <x-inputs.group class="w-full">
        ...
        <x-inputs.text
            name="alamat"
            :value="old('alamat', ($editing ? $admin->alamat : ''))"
            maxlength="255"
            placeholder="Alamat"
            required
        ></x-inputs.text>
    ...
    <x-inputs.group class="w-1/2">
        ...
        <x-inputs.text
            name="no_telepon"
            :value="old('no_telepon', ($editing ? $admin->no_telepon : ''))"
            maxlength="255"
    ...
    <x-inputs.group class="w-1/2">
        ...
        <x-inputs.date
            name="tanggal_lahir"
            value="{{ old('tanggal_lahir', ($editing ? optional($admin->tanggal_lahir)->format('Y-m-d') : '')) }}"
            max="255"
            required
        ></x-inputs.date>
    </x-inputs.group>
