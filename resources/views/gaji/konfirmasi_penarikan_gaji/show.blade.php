<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-partials.card>
                <x-slot name="title">
                    <a href="{{ route('konfirmasi_penarikan_gaji.index') }}" class="mr-4"
                ...
                <div class="mt-4 px-4 row">
                    <div class="col-md-6">
                        <div class="mb-4">
                            ...
                            <span>{{ $konfirmasi_penarikan_gaji->user->nama ?? '-' }}</span>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <span>{{ IDR($konfirmasi_penarikan_gaji->gaji_yang_diajukan) ?? '-' }}</span>
                        ...
                        <div class="mb-4">
                            ...
                            @if ($konfirmasi_penarikan_gaji->status == 'Diajukan')
                                <div
                                    ...
                                    "
                                >
                                    <span>{{ $konfirmasi_penarikan_gaji->status ?? '-' }}</span>
                                </div>
                            @elseif ($konfirmasi_penarikan_gaji->status == 'Diterima')
                                <div
                                    style="min-width: 80px;"
                                    class=" 
                                        inline-block
                            ...
                            @elseif ($konfirmasi_penarikan_gaji->status == 'Ditolak')
                                <div
                                    style="min-width: 80px;"
                                    class=" 
                                        inline-block
                    ...
                    <div class="col-md-6">
                        <div class="mb-4">
                            ...
                            <span>{{ $konfirmasi_penarikan_gaji->mulai_tanggal ?? '-' }}</span>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <span>{{ $konfirmasi_penarikan_gaji->akhir_tanggal ?? '-' }}</span>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <span>{{ $konfirmasi_penarikan_gaji->gaji_diberikan ?? '-' }}</span>
                        </div>
                    </div>
                </div>

                <div class="mt-10">
                    <a href="{{ route('konfirmasi_penarikan_gaji.index') }}" class="button">
                ...
                <table class="table">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th>{{ IDR($konfirmasi_penarikan_gaji->gaji_yang_diajukan) }}</th>
                        </tr>
                    </tfoot>
                </table>
            </div>
